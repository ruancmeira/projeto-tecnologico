  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-600 font-medium mt-2">Visão geral do sistema de gestão de saúde</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-sm text-slate-600 font-medium">Pacientes cadastrados</p>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-800">{totalDoctors}</div>
            <p className="text-sm text-slate-600 font-medium">Médicos cadastrados</p>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-800">{totalAppointments}</div>
            <p className="text-sm text-slate-600 font-medium">Consultas agendadas</p>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-slate-800">{appointmentsToday}</div>
            <p className="text-sm text-slate-600 font-medium">Consultas hoje</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border border-slate-200 bg-white shadow-sm">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-slate-800">Próximas Consultas</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              return (
                <div key={appointment.id} className="flex items-center justify-between p-4 border border-slate-200 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors">
                  ...
                  <div className="text-right">
                    ...
                    <span className={`inline-block px-3 py-1 rounded text-xs font-semibold ${getStatusColor(appointment.status)}`}>
